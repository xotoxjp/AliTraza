...
<div class ='botonera'>    
  ...
  <input class='btn btn-success' type='button' id='nuevo' name='nuevo'  value='nuevo'/>
  <input class="btn btn-warning" type='button' id='editar' name='editar' value='editar'/>  
  <input class='btn btn-danger'  type='button' id='eliminar' name='elimnar' value='eliminar'/>  
</div>
<?php
